...
<template>
  <AppGuestLayout>
    ...
    <div v-if="status" class="mb-4 flex justify-center text-sm font-medium text-green-600">
      {{ status }}
    </div>
    ...
    <form @submit.prevent="submit">
      <div class="flex items-center p-6">
        <div
          class="mx-auto h-full max-w-md flex-1 overflow-hidden rounded-lg bg-white shadow-xl md:max-w-4xl dark:bg-gray-800"
        >
          <div class="flex flex-col overflow-y-auto md:flex-row">
            ...
            <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
              <div class="w-full">
                ...
                <div class="mt-4">
                  <SecondaryButton
                    class="flex w-full items-center justify-center fill-current leading-3 hover:fill-lime-700 hover:text-lime-700"
                    :outlined="true"
                  >
                    <svg class="mr-2 h-4 w-4" aria-hidden="true" viewBox="0 0 24 24" fill="current">
                      <path
                ...
                <div class="mt-4">
                  <SecondaryButton
                    ...
                    :outlined="true"
                  >
                    <svg class="mr-2 h-4 w-4" aria-hidden="true" viewBox="0 0 256 256" fill="current">
                      <g>
                        <path
