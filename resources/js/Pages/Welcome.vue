...
const items = [
    'Services', 'Portfolio', 'My Skills & CV', 'Contacts'
];
</script>
...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50 min-h-screen px-4">
        ...
        <div class=" max-w-6xl mx-auto">
            ...
            <ContentBox v-for="item in items" class=" min-h-32 flex justify-center items-center col-span-1">
               <h3 class="heading-3">{{ item }}</h3>
            </ContentBox>
        </div>
        </div>
