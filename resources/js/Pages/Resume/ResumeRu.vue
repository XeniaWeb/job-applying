                ...
                <tbody>
                  ...
                  <tr class="border-r border-black">
                    <td class="px-4 pb-2 h-[30px]">
                      ...
                      <p class="text-small pb-2">Фреймворки: Laravel InertiaJs Tailwind Vue.js React TypeScript</p>
                ...
                <tbody class="align-top">
                  ...
                  <tr>
                    <td class="px-4 h-[30px] text-[14px]">
                      <p class="text-small pb-1">Backend PHP на Laravel, ООП на PHP, MVC паттерны,</p>
                      ...
                      <p class="text-small pb-1">HTML, CSS3, SASS, Tailwind, JS, Vue.js 3, Vite, Web-стандарты</p>
                      <p class="text-small pb-1">Docker, GitHub, CI/CD, API Documentation, Linux</p>
                      <p class="text-small pb-1">Опыт командной разработки на принципах Agile и Scrum</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="px-4 py-2 h-[30px]">
                      <p class="sub-title pb-2 border-b border-black">Опыт работы</p>
                      <table class="w-full text-black dark:text-white">
                        <tbody>
                          <tr class="text-left">
                            ...
                            <td class="px-2 pb-2 align-top">
                              ...
                              <p class="">
                                ...
                                <a href="https://gocpa.ru/" class="text-small hover:text-red-600" target="_blank"
                                  >gocpa.ru
                                </a>
                              </p>

                              <p class="text-small">
                                •разработка интерфейсов личных кабинетов (статистика, электронный документооборот,
                                CRUD-интерфейсы, система тикетов, рассылки и тд) •система управления ролями и доступами
                                пользователей •добавление новых сущностей в БД через миграции, написание запросов через
                                Eloquent •вёрстка интерфейсов с использованием компонентов •применение git, npm, artisan
                                commands, docker •понимание паттерна MVC, использую в работе функционал Laravel:
                                middlewares, commands, service providers, observers.
                              </p>
                            </td>
                          </tr>
                          <tr class="text-left">
                            ...
                            <td class="px-2 pb-2 align-top">
                              ...
                              <p class="text-small">• разработка сайтов для частных клиентов</p>
                            </td>
                          </tr>
                          <tr class="text-left">
                          ...
                          <tr class="text-left">
                            ...
                            <td class="px-2 pb-2 align-top pt-1">
                              <p class="">
                                <span class="font-semibold mb-1 text-[14px] inline-block border-b border-black mr-2">
                                  Региональный менеджер, </span
                                ><span class="font-semibold"> SibAutoSvet Ltd.,</span>
                              </p>
                              <p class="">
                          ...
                          <tr>
                            <td colspan="2" class="text-small">Я работаю с 1992 года...</td>
                          </tr>
                        </tbody>
                      </table>
                    </td>
                  ...
                  <tr>
                    <td class="px-4 py-2 h-[30px]">
                      <p class="sub-title pb-2 border-b border-black">Образование</p>
                      <p class="text-small pb-1">
                        04/2023 - 09/2023
                        <span class="font-semibold">OTUS,</span> Москва, Россия Практический курс:
                        <span class="font-semibold">• Vue.js разработчик</span>
                        <a
                          href="https://otus.ru/certificate/dc966ecaa1074cc89f35cb3ca8338e0f/"
                      ...
                      <p class="text-small pb-1">
                        07/2021 - 01/2022
                        <span class="font-semibold">OTUS,</span> Москва, Россия Практический курс:
                        <span class="">• Backend-разработчик на PHP</span>
                        <a
                          href="https://otus.ru/certificate/a886355b64e54948a89132790645b563/"
                          class="hover:text-red-600"
                          target="_blank"
                          >(сертификат)</a
                        >
                      ...
                      <p class="text-small pb-1">
                        03/2020 - 06/2020
                        <span class="font-semibold">LoftSchool,</span> Санкт-Петербург, Россия Практический курс:
                        <span class="font-semibold">• Vue.js Продвинутая веб разработка </span
                        ><a
                          href="https://loftschool.com/diploma/JL1584462302/ru/pdf"
                          class="hover:text-red-600"
                          target="_blank"
                          >(сертификат)</a
                        >
                      ...
                      <p class="text-small pb-1">
                        06/2019 - 09/2019
                        <span class="font-semibold">LoftSchool,</span> Санкт-Петербург, Россия Практический курс:
                        <span class="font-semibold">• Комплексное обучение PHP / Laravel </span
                        ><a
                          href="https://loftschool.com/diploma/QP1560523303/ru/pdf"
                          class="hover:text-red-600"
                          target="_blank"
                          >(сертификат)</a
                        >
                      ...
                      <p class="text-small pb-1">
                        ...
                        <span class="font-semibold">• PHP programming and MySQL</span> (сертификат)
                        <span class="font-semibold">• HTML / CSS</span> (сертификат)
                        <span class="font-semibold">• JavaScript programming</span> (сертификат)
                      </p>
                      <p class="text-small pb-1">
                        1999 - 2001 Новосибирский государственный университет архитектуры, дизайна и искусств,
                        Новосибирск, Россия • Дизайн интерьера. Ландшафтный дизайн. (курсы)
                      </p>
                      <p class="text-small pb-1">
                        1998 - 2000 Новосибирский Государственный Университет Экономики и Управления (НГУЭУ),
                        Новосибирск, Россия • Финансы и кредит
                      </p>
                      <p class="text-small pb-1">
                        1985 – 1992 Институт технологии и дизайна, Новосибирск, Россия <br />
                        • Инженер-технолог швейного производства (ТШИ)
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td class="px-4 py-2 h-[30px]">
                      <p class="sub-title pb-2 border-b border-black">Владение языками</p>
