                ...
                <tbody>
                  ...
                  <tr class="border-r border-black">
                    <td class="px-4 h-[30px] text-[16px] font-semibold">
                      <p style="font-weight: 400; font-size: 16px" class="inline-block pb-2">PHP Web Entwicklerin</p>
                    </td>
                  </tr>
                  <tr class="border-r border-black">
                ...
                <tbody class="align-top">
                  ...
                  <tr>
                    <td class="px-4 h-[30px] text-[14px]">
                      ...
                      <p class="text-small pb-1">Docker, GitHub, CI/CD, API-Dokumentation</p>
                      <p class="text-small pb-1">Teamarbeit basierend auf Agile- und Scrum-Prinzipien</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="px-4 py-2 h-[30px]">
                      <p class="sub-title pb-2 border-b border-black">Arbeitserfahrung</p>
                      <table class="w-full text-black dark:text-white">
                        <tbody>
                          <tr class="text-left">
                            ...
                            <td class="px-2 pb-2 align-top">
                              ...
                              <p class="text-small">
                                ...
                                • Hinzufügen neuer Entitäten zur Datenbank durch Migrationen, Schreiben von Abfragen
                                über Eloquent, Arbeiten mit Zeilenabfragen PostgreSQL, MySQL<br />
                                • Entwicklung von Schnittstellen für persönliche Accounts (Statistiken, elektronische
                                Dokumentenverwaltung, CRUD-Schnittstellen, Ticketsystem, Mailinglisten, und s.w.) •
                                Layout von Schnittstellen mithilfe Komponenten <br />
                                • MVC-Pattern, das die Laravel-Funktionalität in meiner Arbeit verwendet: Middlewares,
                                Befehle, Dienstanbieter, Beobachter <br />
                          ...
                          <tr class="text-left">
                            ...
                            <td class="px-2 pb-2 align-top">
                              ...
                              <p class="text-small">• Entwicklung von Websites für Privatkunden</p>
                            </td>
                          </tr>
                          <tr class="text-left">
                          ...
                          <tr class="text-left">
                            ...
                            <td class="px-2 pb-2 align-top pt-1">
                              ...
                              <p class="">
                                <span class="font-semibold"> SibAutoSvet Ltd.,</span>Großhandel mit Autolichtern.
                              </p>
                            </td>
                          </tr>
                          <tr>
                            <td colspan="2" class="text-small">Ich arbeite seit 1992 ...</td>
                          </tr>
                        </tbody>
                      </table>
                    </td>
                  ...
                  <tr>
                    <td class="px-4 py-2 h-[30px]">
                      <p class="sub-title pb-2 border-b border-black">Ausbildung</p>
                      <p class="text-small pb-1">
                        04/2023 - 09/2023
                        <span class="font-semibold">OTUS,</span> Moskau, Russland Praktischer Kurs:
                      ...
                      <p class="text-small pb-1">
                        03/2020 - 06/2020
                        <span class="font-semibold">LoftSchool,</span> St. Petersburg, Russland Praktischer Kurs:
                      ...
                      <p class="text-small pb-1">
                        06/2019 - 09/2019
                        <span class="font-semibold">LoftSchool,</span> St. Petersburg, Russland Praktischer Kurs:
                        <span class="font-semibold">• PHP-Programmierung mit Laravel </span
                        ><a
                      ...
                      <p class="text-small pb-1">
                        ...
                        <span class="font-semibold">• PHP-Programmierung und MySQL</span> (Zertifikat)
                        <span class="font-semibold">• HTML / CSS</span> (Zertifikat)
                        <span class="font-semibold">• JavaScript-Programmierung</span> (Zertifikat)
                      </p>
                      <p class="text-small pb-1">
                        1999 - 2001 Staatliche Akademie für Architektur und Kunst, Nowosibirsk, Russland • Kurs für
                        Innenarchitektur und Landschaftsbau
                      </p>
                      <p class="text-small pb-1">
                        1998 - 2000 Staatliche Universität für Wirtschaft und Management (NSUEM), Nowosibirsk, Russland
                        • Finanzen und Kredit
                      </p>
                      <p class="text-small pb-1">
                        1985 – 1992 Institut für Technologie und Design, Nowosibirsk, Russland • Ingenieurabschluss •
                        Technologie der Textil- und Bekleidungsindustrie
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td class="px-4 py-2 h-[30px]">
                      <p class="sub-title pb-2 border-b border-black">Sprachen</p>
