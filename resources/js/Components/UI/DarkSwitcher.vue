...
<template>
    <div class="flex items-center justify-between"><label for="theme"
                                                          class="text-slate-700 font-normal dark:text-slate-400">Switch
        theme</label>
        <div
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                 class="w-6 h-6 mr-2 dark:hidden">
            ...
            <svg class="w-6 h-6 ml-2 text-slate-400" fill="none">
                <path d="m15 11-3 3-3-3" stroke="currentColor" stroke-width="2" stroke-linecap="round"
    ...
    <ul class=" z-50 top-full right-0 bg-white rounded-lg ring-1 ring-slate-900/10 shadow-lg overflow-hidden w-36 py-1 text-sm text-slate-700 font-semibold dark:bg-slate-800 dark:ring-0 dark:highlight-white/5 dark:text-slate-300 mt-8"
        aria-labelledby="headlessui-listbox-button-:R19kcr6:" aria-orientation="vertical"
        id="headlessui-listbox-options-:R1pkcr6:" role="listbox" tabindex="0" data-headlessui-state="open">
        <li class="py-1 px-2 flex items-center cursor-pointer text-sky-500" id="headlessui-listbox-option-:r2:"
            role="option" tabindex="-1" aria-selected="true" data-headlessui-state="selected">
            <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                 class="w-6 h-6 mr-2">
        ...
        <li class="py-1 px-2 flex items-center cursor-pointer" id="headlessui-listbox-option-:r3:" role="option"
        ...
        <li class="py-1 px-2 flex items-center cursor-pointer" id="headlessui-listbox-option-:r4:" role="option"
            tabindex="-1" aria-selected="false" data-headlessui-state="">
            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6 mr-2">
