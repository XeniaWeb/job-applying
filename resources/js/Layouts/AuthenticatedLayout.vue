...
<template>
  <div>
    <div class="min-w-[380px] min-h-screen bg-gray-100 dark:bg-gray-900">
          ...
          <div class="flex justify-between">
            <div class="flex">
              ...
              <div class="shrink-0 flex items-center">
                <Link
                  :href="route('welcome')"
                  class="focus:outline-none focus:ring focus:ring-offset-8 focus:rounded-lg focus:ring-primary-hover"
                >
                  <AppLogoXeniaWebMB class="block h-auto w-36 fill-current text-gray-800 dark:text-gray-200" />
                </Link>
              </div>
      ...
      <!-- Page Heading -->
      <header
        class="bg-white dark:bg-gray-900 shadow dark:shadow-gray-800 shadow-gray-300 w-full z-10"
        v-if="$slots.header"
      >
